...
def benchmark_alpha(pipelines, max_n_subjects = -1, overwrite = False):
    ...
    datasets_P300 = [BI2013a(), BNCI2014_008(), BNCI2014_009(), BNCI2015_003(), BI2015a(), BI2015b(), BI2014a(), BI2014b()] # Sosulski2019(), EPFLP300()
...
def plot_stat(results):
    ...
    for i in range(0,len(pipelines_sorted)):
        for j in range(i+1,len(pipelines_sorted)):
            fig = moabb_plt.meta_analysis_plot(stats, pipelines_sorted[i], pipelines_sorted[j])
            plt.show()
