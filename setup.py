...
setup(name='pyriemann-qiskit',
      ...
      platforms='any',
      python_requires=">=3.6",
      install_requires=['cython', 'pyriemann @ git+https://github.com/pyRiemann/pyRiemann#egg=pyriemann', 'qiskit==0.20.0',
                        'cvxpy==1.1.12; python_version < "3.8.0"',
                        'cvxpy==1.1.15; python_version >= "3.8.0"'],
