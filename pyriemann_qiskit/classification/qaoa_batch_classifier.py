...
class QAOABatchClassifier(QAOACVAngleOptimizer, ClassifierMixin):
    ...
    def __init__(
        ...
        super().__init__(
            create_mixer=create_mixer if create_mixer is not None 
    ...
    def _solve_qp(self, qp, reshape=False):
        ...
        def loss(params):
            ...
            for i in range(n_samples):
                ...
                loss_i = -(y_true * np.log(prob_pred) + 
                          (1 - y_true) * np.log(1 - prob_pred))
                total_loss += loss_i
        ...
        # Optimize
        print(f"Training QAOA classifier with {n_samples} samples, "
    ...
    def predict_proba(self, X):
        ...
        for i in range(n_samples):
            ...
            prob_class_1 = self._extract_class_probability(
                state_vec, self.n_features_
            )
