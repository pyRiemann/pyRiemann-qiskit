...
`pyRiemann-qiskit` currently supports Windows, Mac and Linux OS with Python 3.11 - 3.12.
...
- `pyRiemann==0.10 <https://github.com/pyRiemann/pyRiemann>`

- `qiskit==2.4.1 <https://qiskit.org/>`__
