# -*- coding: utf-8 -*-
#
# pyRiemann-qiskit documentation build configuration file, created by
...
# Suppress warnings for unreferenced citations
...
htmlhelp_basename = 'pyriemann_qiskit_doc'
...
latex_documents = [
    (master_doc, 'pyriemann_qiskit.tex', u'pyriemann-qiskit Documentation',
     u'Gregoire Cattan', 'manual'),
]
...
man_pages = [(master_doc, 'pyriemann-qiskit', u'pyRiemann-qiskit Documentation', [author],
              1)]
...
texinfo_documents = [
    (master_doc, 'pyriemann-qiskit', u'pyRiemann-qiskit Documentation', author, 'pyriemann-qiskit',
     'Qiskit wrapper for pyRiemann', 'Miscellaneous'),
]
